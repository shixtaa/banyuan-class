<template>
  <div class="container">
    <div class="aside">
      <span>姓名:{{this.$store.state.login.list.name}}</span>
      <span>学校:{{this.$store.state.login.list.school}}</span>
      <span>性别:{{this.$store.state.login.list.gender}}</span>
      <span>年龄:{{this.$store.state.login.list.age}}</span>
    </div>
